...
#CUDA_VISIBLE_DEVICES=0 nnUNetv2_train "Dataset003_GLAND" "2d" 0
#CUDA_VISIBLE_DEVICES=1 nnUNetv2_train "Dataset003_GLAND" "2d" 1
#CUDA_VISIBLE_DEVICES=2 nnUNetv2_train "Dataset003_GLAND" "2d" 2
#CUDA_VISIBLE_DEVICES=3 nnUNetv2_train "Dataset003_GLAND" "2d" 3
#CUDA_VISIBLE_DEVICES=4 nnUNetv2_train "Dataset003_GLAND" "2d" 4
